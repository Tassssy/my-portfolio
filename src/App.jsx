  ...
  return <>
    ...
    <main>
      <section id="home" className="hero wrap">
        ...
        <div className="hero-visual" onPointerMove={moveArt} onPointerLeave={()=>heroArt.current.style.transform=''}><div className="orbit orbit-one"/><div className="orbit orbit-two"/><span className="visual-label top-label">CURIOUS MIND.<br/>CREATIVE HEART.</span><div className="hero-photo-slip"><img src={assetUrl("/media/personal-red.webp")} alt="周天翊的校园生活照" width="680" height="453"/><span>THINK / MAKE / FEEL</span></div><div className="identity-card" ref={heroArt}><div className="identity-top"><span>HELLO, I’M</span><span>✳</span></div><div className="identity-name">TIANYI<br/>ZHOU<span>周天翊</span></div><div className="identity-graphic"><div className="graphic-oval"/><div className="graphic-line"/><Star/></div><div className="identity-bottom"><span>INSIGHT → IDEA → IMPACT</span><span>EDITION 02</span></div></div><div className="floating-tag tag-insight"><span>↗</span> 数据里找洞察</div><div className="floating-tag tag-creative"><Star/> 创意里见共鸣</div><span className="visual-label bottom-label">FINANCE × MARKETING<br/>A DIFFERENT PERSPECTIVE.</span><div className="circle-note">保持好奇<span>STAY CURIOUS ↗</span></div></div>
    ...
    <CaseStudy project={selected} onClose={closeProject}/>
