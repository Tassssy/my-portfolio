...
export function LifeGallery() {
  ...
  return <div className="life-gallery">
    <div className="life-gallery-heading"><div><p className="section-kicker">04 / OFF THE CLOCK · 生活的切片</p><h3>也在生活里，收集灵感。</h3><p>听音乐、去远方，也认真享受普通的一天。</p></div><div className="life-controls"><button type="button" onClick={()=>move(-1)} disabled={edges.start} aria-label="向前浏览生活照片">←</button><button type="button" onClick={()=>move(1)} disabled={edges.end} aria-label="向后浏览生活照片">→</button></div></div>
