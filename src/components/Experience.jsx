...
export function Experience({ onOpen }) {
  return <section id="experience" className="experience section"><div className="wrap"><div className="section-heading"><div><p className="section-kicker">02 / REAL-WORLD EXPERIENCE</p><h2>在真实商业中，<br/>练习把事情做好。</h2></div><span className="experience-decoration" aria-hidden="true">↗</span></div>
