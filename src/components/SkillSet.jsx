...
export function SkillSet() {
  return <div className="skills-toolkit"><div className="toolkit-title"><span className="small-label">MY TOOLKIT / 常用工具</span><Toolkit/></div>
    ...
    <div className="toolkit-language"><span className="language-icon" aria-hidden="true">A<span>文</span></span><div><h4>LANGUAGE / 语言</h4><p><span>IELTS <strong>7.0</strong></span><span>普通话 <strong>二级甲等</strong></span></p></div></div>
  </div>;
}
